...
public class JMLChecker implements JMLOption{
    ...
    static public class CoverageCount {
    	...
    	public CoverageCount(String loc) { location = loc; }
    	public void incr(boolean v) {
    		if (v) ++trueCount; else ++falseCount;
    	}
    }

    static public void clearCoverage() { coverage = new Hashtable(); }
