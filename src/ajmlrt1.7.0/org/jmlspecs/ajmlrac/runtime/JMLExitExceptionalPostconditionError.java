...
extends JMLExceptionalPostconditionError {
	 ...
	 */
	public JMLExitExceptionalPostconditionError(String message) {
		super(message);
	}
	 ...
	 */
	public JMLExitExceptionalPostconditionError(String message, String methodName, Throwable cause)
	{
		super(message, methodName, cause);
	}

	public JMLExitExceptionalPostconditionError(Throwable cause) {
		super(cause);
	}
}
