...
public class JMLEntryDefaultPreconditionError extends JMLEntryPreconditionError {
	 ...
	 */
	public JMLEntryDefaultPreconditionError(String message) {
		super(message);
	}
     ...
     */
    public JMLEntryDefaultPreconditionError(String message, String methodName)
    {
        super(message, methodName);
    }
	
	public JMLEntryDefaultPreconditionError(Throwable cause) {
		super(cause);
	}
}
