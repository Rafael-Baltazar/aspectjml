...
public class JMLEntryPublicPreconditionError extends JMLEntryPreconditionError {

	/**
	 * Creates a new instance from the given assertion message error. 
	 */
	public JMLEntryPublicPreconditionError(String message) {
		super(message);
	}
     ...
     */
    public JMLEntryPublicPreconditionError(String message, String methodName)
    {
        super(message, methodName);
    }
	
	public JMLEntryPublicPreconditionError(Throwable cause) {
		super(cause);
	}
}
