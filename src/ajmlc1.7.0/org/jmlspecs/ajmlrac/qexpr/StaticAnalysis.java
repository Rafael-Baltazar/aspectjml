...
//    		whileLoops.append(generateLoopAsString(varDefs[i], rangePredicate(), cond, null));
//    		String s = "";
//    		code.append(s.replace("$1", preQCode+resultStr));
//    		System.out.println("Opa!");
	...
	* parm "vType" is the type of strResultVar and v2
	*
