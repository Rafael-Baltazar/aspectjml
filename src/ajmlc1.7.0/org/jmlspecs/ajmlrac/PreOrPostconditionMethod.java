...
//	protected boolean isLocalToCurrentType(){
//		
//	}
...
//					System.out.println("crossRefAdvice = "+crossRefAdvice);
	...
	private String processingXCSPointcut(String xcsParentClassName,
		...
		// handling execution pointcut
//		Pattern execPattern = Pattern.compile("execution(\\s)*\\((.)*\\)");
//		Matcher execMatcher = execPattern.matcher(xcsPCTmp);
//		if(execMatcher.find()){
//			if(Main.aRacOptions.clientAwareChecking() || Main.aRacOptions.noExecutionSiteInstrumentation()){
//				JmlRacGenerator.fail(TokenReference.build(this.methodDecl.getTokenReference().file(), adviceAnno.getLineNumber()), 
//						JmlMessages.INVALID_POINTCUT_EXEC, this.methodDecl.ident());
//				System.exit(0); // just because of the duplication of error messages ... [[[hemr]]]
//			}
//		}
		// handling call pointcut
//		Pattern callPattern = Pattern.compile("call(\\s)*\\((.)*\\)");
//		Matcher callMatcher = callPattern.matcher(xcsPCTmp);
//		if(callMatcher.find()){
//			if(!Main.aRacOptions.clientAwareChecking() && !Main.aRacOptions.callSiteInstrumentation()){
//				JmlRacGenerator.fail(TokenReference.build(this.methodDecl.getTokenReference().file(), adviceAnno.getLineNumber()), 
//						JmlMessages.INVALID_POINTCUT_CALL, this.methodDecl.ident());
//				System.exit(0); // just because of the duplication of error messages ... [[[hemr]]]
//			}
//		}
...
//	private String getInheritedPreFromSuperTypes(List inheritedMethsWithPreITD,
//			String inheritedPreFromSuperTypes) {
//
//		for (Iterator iterator = inheritedMethsWithPreITD.iterator(); iterator.hasNext();) {
//			CMethod currentMethod = (CMethod) iterator.next();
//			String type = currentMethod.getJavaName();
//			type = type.replace("."+currentMethod.ident(), "");
//			inheritedPreFromSuperTypes += "File \\\""+type+".java\\\", which is inherited\\n"; 				
//		}
//		return inheritedPreFromSuperTypes;
//	}
