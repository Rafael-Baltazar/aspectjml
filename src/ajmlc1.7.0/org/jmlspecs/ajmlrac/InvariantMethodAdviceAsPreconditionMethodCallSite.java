 ...
 *
 * $Id: InvariantMethodAdviceAsPreconditionMethodCallSite.java,v 1.0 2013/08/1 11:45:45 henriquerebelo Exp $
 */
 ...
 */
public class InvariantMethodAdviceAsPreconditionMethodCallSite extends InvariantLikeMethod{
	// ----------------------------------------------------------------------
	// CONSTRUCTORS
	// ----------------------------------------------------------------------
	 ...
	 */
	public InvariantMethodAdviceAsPreconditionMethodCallSite(boolean isStatic, JmlTypeDeclaration typeDecl, VarGenerator varGen)
	{ 
	...
	protected StringBuffer buildBeforeAdvice() 
	{
		...
		if((this.hasInstInv) || (this.hasStatInv)){
			...
			if( (this.hasInstInv) && (this.hasStatInv)){	
				...
				code.append(")").append(" :");
				code.append("\n");
				code.append("   (call(!static * *(..))").append(adviceexecution).append(")");
				code.append(" && ");
				code.append("\n");	
