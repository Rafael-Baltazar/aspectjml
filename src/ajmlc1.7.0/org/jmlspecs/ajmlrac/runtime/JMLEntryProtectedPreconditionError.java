...
public class JMLEntryProtectedPreconditionError extends JMLEntryPreconditionError {

	/**
	 * Creates a new instance from the given assertion message error. 
	 */
	public JMLEntryProtectedPreconditionError(String message) {
		super(message);
	}
     ...
     */
    public JMLEntryProtectedPreconditionError(String message, String methodName)
    {
        super(message, methodName);
    }
	
	public JMLEntryProtectedPreconditionError(Throwable cause) {
		super(cause);
	}
}
