...
public interface JmlJDLexerTokenTypes {
	int EOF = 1;
	...
	int AFFIRM = 304;
	int WS = 305;
	int ML_EMPTY_COMMENT = 306;
	int EMBEDDED_JML_CLOSE = 307;
	int SL_COMMENT = 308;
	int ML_COMMENT = 309;
	int ML_COMMENT_REST = 310;
	int OPTIONAL_PLUS = 311;
	int NOWARN_LABEL_LIST = 312;
	int NOWARN_LABEL = 313;
	int SKIP_TO_SEMI = 314;
	int NON_NL_WS = 315;
	int NEWLINE = 316;
	int ESC = 317;
	int HEX_DIGIT = 318;
