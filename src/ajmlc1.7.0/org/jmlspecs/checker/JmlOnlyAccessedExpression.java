 ...
 *
 * $Id: JmlOnlyAccessedExpression.java,v 1.1 2005/09/12 19:02:00 cruby Exp $
 */
...
public class JmlOnlyAccessedExpression extends JmlStoreRefListWrapper {

    //---------------------------------------------------------------------
    // CONSTRUCTORS 
    //---------------------------------------------------------------------
    public JmlOnlyAccessedExpression( TokenReference where,
	...
	if (p instanceof JmlVisitor)
	    ((JmlVisitor)p).visitJmlOnlyAccessedExpression(this);
	else
