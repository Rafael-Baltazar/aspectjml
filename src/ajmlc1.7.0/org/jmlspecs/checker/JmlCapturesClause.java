 ...
 *
 * $Id: JmlCapturesClause.java,v 1.3 2005/04/26 02:40:16 kui_dai Exp $
 */
...
/**
 * An AST node class representing the JML <tt>captures</tt> clause.
 * The <tt>callable</tt> is mainly for specifying the subclassing
 * contract. The production rule for the <tt>captures</tt> clause
 * is defined as follows.
 *
 * <pre>
 *  captures-clause ::= captures-keyword object-ref-list ";"
 *  captures-keyword ::= object-ref [ "," object-ref ] ...
 *    | store-ref-keyword
...
public class JmlCapturesClause extends JmlSpecBodyClause {
    ...
    public JmlCapturesClause( TokenReference where,
    ...
    /**
     * Typechecks this <code>captures</code> clause in the given
	...
	if (p instanceof JmlVisitor)
	    ((JmlVisitor)p).visitJmlCapturesClause(this);
	else
