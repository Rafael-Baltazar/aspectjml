 ...
 *
 * $Id: JmlNotModifiedExpression.java,v 1.6 2005/09/12 19:02:00 cruby Exp $
 */
...
public class JmlNotModifiedExpression extends JmlStoreRefListWrapper {

    //---------------------------------------------------------------------
    // CONSTRUCTORS 
    //---------------------------------------------------------------------
    public JmlNotModifiedExpression( TokenReference where,
	...
	if (p instanceof JmlVisitor)
	    ((JmlVisitor)p).visitJmlNotModifiedExpression(this);
	else
