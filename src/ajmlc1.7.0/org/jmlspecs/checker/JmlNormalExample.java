 ...
 *
 * $Id: JmlNormalExample.java,v 1.5 2005/04/26 02:40:17 kui_dai Exp $
 */
...
/**
 * A class representing JML normal example specifications. A normal
 * example specification is an example specification
...
public class JmlNormalExample extends JmlExample {
     ...
     * </jml></pre>
     */
    public JmlNormalExample( TokenReference where, 
			     long privacy,
	...
	if (p instanceof JmlVisitor)
	    ((JmlVisitor)p).visitJmlNormalExample(this);
	else
