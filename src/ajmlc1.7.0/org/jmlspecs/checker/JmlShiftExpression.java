 ...
 *
 * $Id: JmlShiftExpression.java,v 1.1 2003/06/10 19:38:17 f_rioux Exp $
 */
 ...
 */
public class JmlShiftExpression extends JShiftExpression {
     ...
     */
    public JmlShiftExpression( TokenReference where,
    			   int oper,
			   JExpression left,
			   JExpression right ) {
