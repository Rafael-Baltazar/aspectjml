 ...
 *
 * $Id: JmlAddExpression.java,v 1.9 2004/07/09 15:55:41 f_rioux Exp $
 */
...
public class JmlAddExpression extends JAddExpression {
     ...
     */
    public JmlAddExpression( TokenReference where,
			   JExpression left,
			   JExpression right ) {
     ...
     * general we might not be able to represent as a literal the sum of two
     * <code>\bigint</code>'s or <code>\real</code>'s.
     * @return	this
     */
    // requires left.isConstant() && right.isConstant() 
    //   && left.getType().isNumeric() &&
    //   && right.getType().isNumeric();
