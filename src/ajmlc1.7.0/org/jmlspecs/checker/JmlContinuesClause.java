 ...
 *
 * $Id: JmlContinuesClause.java,v 1.4 2004/07/01 18:43:11 leavens Exp $
 */
...
public class JmlContinuesClause extends JmlLabeled {
    ...
    // CONSTRUCTORS 
    //---------------------------------------------------------------------
    public JmlContinuesClause( TokenReference where,
	...
	return PORDER_CONTINUES_CLAUSE;
    }
	...
	if (p instanceof JmlVisitor)
	    ((JmlVisitor)p).visitJmlContinuesClause(this);
	else
