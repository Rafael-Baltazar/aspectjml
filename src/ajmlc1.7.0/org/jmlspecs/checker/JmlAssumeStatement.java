 ...
 *
 * $Id: JmlAssumeStatement.java,v 1.2 2002/03/15 21:43:16 cclifton Exp $
 */
...
public class JmlAssumeStatement extends JmlAssertOrAssumeStatement {
    ...
    // CONSTRUCTORS 
    //---------------------------------------------------------------------
    public JmlAssumeStatement( TokenReference where,
	...
	if (p instanceof JmlVisitor)
	    ((JmlVisitor)p).visitJmlAssumeStatement(this);
	else
