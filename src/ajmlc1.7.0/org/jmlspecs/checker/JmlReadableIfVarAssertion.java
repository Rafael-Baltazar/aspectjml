 ...
 *
 * $Id: JmlReadableIfVarAssertion.java,v 1.6 2005/04/26 02:40:17 kui_dai Exp $
 */
 ...
 * <code>readable</code> <em>id</em> <code>if</code> <em>predicate</em>.
 *
 * @author Curtis Clifton
 * @version $Revision: 1.6 $
 */
public class JmlReadableIfVarAssertion extends JmlVarAssertion {

    //---------------------------------------------------------------------
    // CONSTRUCTORS 
    //---------------------------------------------------------------------
    public JmlReadableIfVarAssertion( TokenReference where, long modifiers, 
	...
	if (p instanceof JmlVisitor)
	    ((JmlVisitor)p).visitJmlReadableIfVarAssertion(this);
	else
