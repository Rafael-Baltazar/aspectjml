 ...
 *
 * $Id: JmlDurationExpression.java,v 1.2 2003/08/13 13:06:43 leavens Exp $
 */
...
public class JmlDurationExpression extends JmlQuotedExpressionWrapper {
    ...
    // CONSTRUCTORS 
    //---------------------------------------------------------------------
    public JmlDurationExpression( TokenReference where, 
	...
	if (!(expression instanceof JMethodCallExpression
	    ...
	    context.reportTrouble(new PositionedError(getTokenReference(),
	       JmlMessages.DURATION_MUST_CONTAIN_METHOD_CALL));
        }
	...
	if (p instanceof JmlVisitor)
	    ((JmlVisitor)p).visitJmlDurationExpression(this);
	else
