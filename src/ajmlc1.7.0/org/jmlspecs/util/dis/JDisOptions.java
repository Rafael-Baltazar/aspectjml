// Generated from JDisOptions.opt
...
/** This class is automatically generated from JDisOptions.opt
 *  and contains member fields corresponding to command-line options.
 */
public class JDisOptions extends org.multijava.dis.DisOptions {

  public JDisOptions(String name) {
    super(name);
  }
  ...
  public void usage() {
    System.err.println("usage: org.jmlspecs.util.dis.Main [option]* [--help] <class-files, class-names>");
    printVersion();  }
